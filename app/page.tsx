    ...
    <main className="site-shell">
      ...
      <section id="top" className="hero-section section-frame">
        ...
        <div className="hero-content">
          ...
          <motion.div className="hero-actions"><a href="#work" className="button button-primary">Explore selected work <ArrowDown size={16} /></a><a href="/Bassam_Alhakim_Systems_Engineer_CV.pdf" target="_blank" rel="noreferrer" className="text-link">View résumé <ArrowUpRight size={15} /></a></motion.div><div className="hero-proof"><div><strong>10</strong><span>shipped systems</span></div><div><strong>15+</strong><span>public repositories</span></div><div><strong>7</strong><span>technology lanes</span></div></div>
        </div>
