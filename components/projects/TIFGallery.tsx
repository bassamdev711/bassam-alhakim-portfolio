...
interface TIFGalleryProps {
  accentColor: string;
}

const images = [
  { src: "/images/projects/tif/2.png", label: "01", caption: "Interactive 3D Bottle Visualizer", type: "desktop" },
  { src: "/images/projects/tif/3.png", label: "02", caption: "Keiro AI Concierge Dialog", type: "desktop" },
  { src: "/images/projects/tif/4.png", label: "03", caption: "Olfactory Pyramid Explorer", type: "desktop" },
  { src: "/images/projects/tif/5.png", label: "04", caption: "Mobile Immersive Boutique", type: "mobile" },
  { src: "/images/projects/tif/6.png", label: "05", caption: "Mobile 1-Click WhatsApp Checkout", type: "mobile" },
];

export default function TIFGallery({ accentColor = "#d97706" }: TIFGalleryProps) {
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    boxShadow: isActive
                      ? `0 30px 80px -15px ${accentColor}60, 0 30px 70px rgba(0,0,0,0.8)`
                ...
                >
                  ...
                  {/* Device badge */}
                  <div className="absolute bottom-5 left-6 flex items-center gap-2 text-[9px] font-black uppercase tracking-[0.2em] bg-black/50 backdrop-blur-sm px-3 py-1.5 rounded-full border border-white/10 text-white/60">
        ...
        {images.map((_, idx) => (
          <button
            ...
            style={{
              ...
              backgroundColor: idx === activeIndex ? accentColor : "rgba(180,100,30,0.2)",
            }}
